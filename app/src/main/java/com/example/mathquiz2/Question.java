...
public class Question {
    ...
    private int answer;
    // ketu jane 4 zgjidhjet qe mujmi me i ba
    private int  [] answerArray;
    // ketu tregojme se cila eshte e sakta 0,1,2,3
    private int answerPosition;
    // vlera maksimale e numrave firstNumber dhe secondNumber
    private int upperLimit;
    //zgjidhja ose rezultati i detyres
